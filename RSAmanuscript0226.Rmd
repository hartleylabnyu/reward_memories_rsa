...
```
# Similar pattern of results when including only items that were retrieved on Day 1

1. Significant effect of reward type (p=.011), marginal effect of age (p=.087)
...
```{r trialwiseVTC, echo = FALSE, message = FALSE, results = "hide"}
...
# aHC ERS by correct/incorrect, separately for adults and children

Model
```{r trialwiseaHC, echo = FALSE, results = "hide"}
# Read in trial-wise VTC ERS data and change variable types
...
```{r VTA_age, echo = FALSE, message = FALSE, results = "hide"}
# Regression model
