...
###### HOW TO RUN: ######
## Run all these functions, then, in the terminal, run the following:
## twolines([y]~[x],graph=1,link="gaussian",data=[df])
# e.g. twolines(memory~age,graph=1,link="gaussian",data=mem_df)
...
###### HOW TO RUN: ######
## Run all these functions, then run Function 4 as follows:
## twolines([y]~[x],graph=1,link="gaussian",data=[df])
# e.g. twolines(memory~age,graph=1,link="gaussian",data=mem_df)
